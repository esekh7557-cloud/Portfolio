            ...
            <div className="order-1 md:order-2 space-y-6">
              ...
              >
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-green-400 font-semibold">+91 98765 43210</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-blue-400 font-semibold break-all">contact@example.com</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-purple-400 font-semibold">+91 98765 43210</p>
                </div>
              </a>
              ...
              <div className="mt-8 p-8 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-white/20 space-y-4">
                ...
                <p className="text-white/80 italic text-lg leading-relaxed">
                  "Professional, responsive, and delivered beyond expectations. Highly recommended!"
                </p>
                <div>
