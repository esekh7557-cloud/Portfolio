      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              <Link href="/projects" className="text-white/70 text-sm hover:text-white transition-colors duration-200 block">Ebrahim Sekh</Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="https://wa.me/917385693147" className="text-white/70 text-sm hover:text-white transition-colors duration-200 flex items-center gap-2" target="_blank" rel="noopener noreferrer">
                WhatsApp
              </a>
              <a href="mailto:digitquo@gmail.com" className="text-white/70 text-sm hover:text-white transition-colors duration-200 flex items-center gap-2">
                digitquo@gmail.com
              </a>
              <a href="tel:+917385693147" className="text-white/70 text-sm hover:text-white transition-colors duration-200 flex items-center gap-2">
                +91 73856 93147
              </a>
              <p className="text-white/70 text-sm leading-relaxed">Ramnagar, Betim, Bardez, North Goa, India</p>
            </div>
          </div>
        </div>
